...
if ($action === 'new') {
    ...
    if (empty($applications)) {
        ...
        foreach ($applications as $application) {
            ...
            $withdrawurl = new moodle_url('/local/special_consideration/withdraw.php', array('id' => $application->id, 'courseid' => $courseid));
            ...
            $actions .= ' | ' . html_writer::link($withdrawurl, get_string('withdraw', 'local_special_consideration'));
